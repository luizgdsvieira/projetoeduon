...
import { getAll, getById, create, deleteAluno, getMyData, getQrCode } from '../controllers/aluno.controller.js';
...
router.get('/:id/qrcode', authenticate, getQrCode); // Rota para obter QR Code do aluno
